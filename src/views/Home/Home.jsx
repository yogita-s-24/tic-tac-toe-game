    ...
    <div className="flex justify-around flex-wrap items-center">
      <div>
        ...
        <div className="flex justify-around mt-14">
          <h1 className="text-xl font-black bg-violet-100 px-9 py-3 rounded-sm ring-2 ring-violet-500 shadow-md">
            Player 1 : ❌
          </h1>
          <h1 className="text-xl font-black bg-violet-100 px-9 py-3 ms-2 rounded-sm ring-2 ring-violet-500 shadow-md">
            Player 2 : ⭕{" "}
          </h1>
        </div>
      ...
      <div>
        <div className="w-fit p-4 bg-violet-500 rounded-sm shadow-sm mt-20">
          <div className="box flex align-center justify-center">
            <div
              className="box bg-violet-100 w-28 h-28 border border-violet-700 hover:shadow-3xl hover:z-50 hover:bg-white flex justify-center items-center text-4xl cursor-pointer"
              onClick={() => {
                play(1);
              }}>
              {board[1]}
